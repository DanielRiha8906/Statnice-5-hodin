...
Console contact manager backed by SQLite.
...
If you prefer opening it in Visual Studio 2022, open `ContactManager.csproj` directly or use the folder `Statnice-5-hodin/SW1/csharp/1`.
